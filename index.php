     ...
     <div class="navbar-header" >
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
       <ul class="nav navbar-nav navbar-right" style="background: ;">
        ...
        <li ><a href="login.php" style="color: white">INICIAR SECCION</a></li>
       </ul>
      </div>
   </div>
  </nav>
...
<div class="container-fluid">
 ...
 <div >
 <img src="img/m.png" style="float: left; width:50%; padding: 10px;" class="imgm">
...
<!--ASIDE-->
  ...
  <img src="img/a1.png" id="img_aside">
  <hr>
  <img src="img/a2.png"  id="img_aside">
  <hr>
  <img src="img/a3.png"  id="img_aside">
  <hr>
  <img src="img/a4.png"  id="img_aside">
  <hr>
  <img src="img/a5.png"  id="img_aside">
</div>
</div>
