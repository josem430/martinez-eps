...
<div class="container ">
 <div class="col-lg-4 col-lg-offset-4">
  <img  src="img/milogo.png" width="200px;">
   <div class="row">
      <div class="col-lg-5">
       <h1 class="titulos"><span style="font-family: Bernard MT Condensed">IniciarSesion</span></h1>      
      </div>
   </div>
...
<?php
  ...
  $consulta=mysqli_query($conexion,"select *from usuarios where USUARIO='$usu' and USUPASSWORD='$contra'");
...
?>
  ...
  <a href="loginadmi.php"><img src="img/admi.png"></a>
</body>
</html>
