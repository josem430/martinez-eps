  ...
  <div class="col-lg-4">                
   ...
   <div class="col-lg-4">
    ...
    <div class="col-lg-4" >
      <ul class=" nav nav-pills nav-justified ">
        <li class="dropdown active">
          <a href="quejas.php"  class="dropdow-toggle" style="background:#A3E4D7;color: #2980B9"><b>PETICIONES, QUEJAS Y RECLAMOS</b></a>  
...
<div class="col-lg-9">
  ...
  <div class="col-lg-3">
    <form  id="form_quejas" class="form" action="guardados/guardar_quejas.php" method="POST" >
      ...
      <textarea class="form-control" name="quejas" placeholder="*Escriba aqui sus peticiones, quejas o reclamos" required=""></textarea>
      <input  type="submit" id="btn_quejas" value="Enviar" class="form-control btn btn-primary">
    </form>        
  </div>
</div>
</div>
